...
[`@aws-sdk/client-ecr`](https://www.npmjs.com/package/@aws-sdk/client-ecr/v/3.664.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ecr@3.664.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zp1cZr75tghirRgT9DxmFSpHKVRNM8Ekt9fdileabDmoNmBLs4Hhl8wNEVU+P9vz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ecr": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ecr@3.664.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ecr@3.664.0/index.min.mjs": "sha384-zp1cZr75tghirRgT9DxmFSpHKVRNM8Ekt9fdileabDmoNmBLs4Hhl8wNEVU+P9vz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ecr/blob/refs/tags/3.664.0/LICENSE
```
